...
verify(
         ...
         * A4:
         *
         * La generacion del reporte MAPFRE prepara el lote,
         * pero NO deriva la carpeta del periodo.
         *
         * El movimiento al destino final ocurre solamente
         * despues de descarga + acuse.
         */
        verify(
                googleDriveService,
                never()
