...
public class ExpedienteDigitalResponse {

    private boolean expedienteRegistrado;
    ...
    private List<EventoExpedienteResponse> eventos = new ArrayList<>();

    public ExpedienteDigitalResponse() {
    }

    public boolean isExpedienteRegistrado() {
        return expedienteRegistrado;
    }

    public void setExpedienteRegistrado(boolean expedienteRegistrado) {
    ...
    public List<EventoExpedienteResponse> getEventos() {
        return eventos;
    }

    public void setEventos(List<EventoExpedienteResponse> eventos) {
