...
public class GenerarDocumentoSelladoResponse {

    private boolean documentoSellado;
    private String mensajeSellado;
    ...
    private boolean requiereVerificacionSello;

    public GenerarDocumentoSelladoResponse() {
    }

    public boolean isDocumentoSellado() {
        return documentoSellado;
    }

    public void setDocumentoSellado(boolean documentoSellado) {
        this.documentoSellado = documentoSellado;
    }

    public String getMensajeSellado() {
        return mensajeSellado;
    }

    public void setMensajeSellado(String mensajeSellado) {
        this.mensajeSellado = mensajeSellado;
    }
    ...
    public boolean isRequiereVerificacionSello() {
        return requiereVerificacionSello;
    }

    public void setRequiereVerificacionSello(boolean requiereVerificacionSello) {
        this.requiereVerificacionSello = requiereVerificacionSello;
    }
}