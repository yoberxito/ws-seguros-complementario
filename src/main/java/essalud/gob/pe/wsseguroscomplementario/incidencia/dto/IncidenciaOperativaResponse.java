...
public class IncidenciaOperativaResponse {
    ...
    private List<ReintentoIncidenciaResponse> reintentos = new ArrayList<>();
    ...
    public List<ReintentoIncidenciaResponse> getReintentos() {
        return reintentos;
    }

    public void setReintentos(List<ReintentoIncidenciaResponse> reintentos) {
