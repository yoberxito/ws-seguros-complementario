...
public class ReintentoIncidenciaOperativa {

    private String idReintento;
    private LocalDateTime fechaHoraReintento;
    ...
    public ReintentoIncidenciaOperativa() {
    }

    public String getIdReintento() {
        return idReintento;
    }

    public void setIdReintento(String idReintento) {
        this.idReintento = idReintento;
    }

    public LocalDateTime getFechaHoraReintento() {
        return fechaHoraReintento;
    }

    public void setFechaHoraReintento(LocalDateTime fechaHoraReintento) {
        this.fechaHoraReintento = fechaHoraReintento;
    }
